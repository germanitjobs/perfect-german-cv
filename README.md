...
This is a work in progress, so not everything is adapted to German rules and norms for CVs. If you're unsure, check out our article on [http://www.germanitjobs.com/blog/a-german-cv-some-dos-and-no-we-always-keep-things-positive/](DOs and DON'Ts for a German CV).
